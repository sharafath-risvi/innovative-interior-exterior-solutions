...
export const INTERIOR_SERVICES = [
  {
    ...
    features: [
      ...
      { name: 'UPVC Windows', id: 'res-upvc' },
      { name: 'Wall Decor', id: 'res-walldecor' },
    ],
    image: '/iiesImages/residential.jpeg',
    icon: '🏠',
    color: '#F78701',
  },
  {
  ...
  },
  {
    ...
    features: [
      { name: 'Gypsum Ceiling', id: 'ceil-gypsum' },
